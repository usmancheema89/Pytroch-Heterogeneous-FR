...
def write_numpy(data, name):
    print(len(data), ' images in:', name)
    data_array = np.array(data)
    np.save(name,data_array)


pairs_file_name = 'SMMD Img Pairs.txt'
pairs_file = read_Json(pairs_file_name)
read_file(pairs_file)

write_numpy(train_labels,'SMMD CMFR Train Labels.npy')
write_numpy(train_vis_images,'SMMD CMFR Train Vis Images.npy')
write_numpy(train_the_images,'SMMD CMFR Train The Images.npy')
write_numpy(test_labels,'SMMD CMFR Test Labels.npy')
write_numpy(test_vis_images,'SMMD CMFR Test Vis Images.npy')
write_numpy(test_the_images,'SMMD CMFR Test The Images.npy')